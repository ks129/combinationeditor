...
docker exec -t temp-ps rm -rf /var/www/html/modules/combinationeditor
...
echo "Run PHPStan using phpstan.neon file"

docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/combinationeditor \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/combinationeditor phpstan/phpstan:1 \
       analyse \
